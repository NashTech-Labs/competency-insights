        ...
        <div class="flex min-h-screen items-center justify-center px-8">
            <div class="group h-96 w-80 [perspective:1000px]">
                <div class="relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    <div class="absolute w-full h-full backface-hidden font-sans bg-white text-black flex flex-col justify-center items-center p-18 shadow-md rounded-10">
                        <div class="w-20 h-20"><img class="rounded-full" src="/nashtech_logo.png" alt="" /></div>
                        ...
                        <p className="text-gray-500 text-base leading-loose">Employee id: {employee.empId}</p>
                    </div>
                    <div class="absolute inset-0 h-full w-full rounded-xl bg-gray-200 px-12 text-center text-black [transform:rotateY(180deg)] [backface-visibility:hidden] z-index: 2;">
                        ...
                        <div class="flex min-h-full flex-col items-center justify-center">
                            ...
                            <Link to={`/profile?email=${encodeURIComponent(employee.email)}`}>
